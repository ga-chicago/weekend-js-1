...
const battle = (one, two) => {      // this is going to look ugly i think no matter how i format this - it's just a big clunky function... could break it up into smaller functions i suppose
let timer = 0;
